...
const FeaturesPane = memo<{ vis: boolean }>(({ vis }) => {
  ...
  return (
    ...
    >
      {/* Left list */}
      <div
        className="combined-features-list"
              ...
              {isActive && (
                <span
                  style={{
                    ...
                    boxShadow: '0 0 5px rgba(196,124,46,0.55)',
                    flexShrink: 0,
                  }}
                />
              )}
      ...
      >
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {f.desc && (
            <p
              className="body-font"
              style={{ fontSize: 11, color: 'var(--film-silver)', lineHeight: 1.65, marginTop: 16 }}
            >
              {f.desc}
            </p>
          )}
  ...
  >
    {USE_CASES.map((uc, i) => (
      ...
      >
        ...
        {uc.codeSnippet && (
          <code
            className="integrations-code mono-font"
            style={{
      ...
      >
        ...
        >
          {tab === 'features'
            ...
            : `${USE_CASES.length} integrations · CORS open · Open source`}
        </span>
        <span
          className="mono-font"
          style={{ fontSize: 8, color: 'var(--film-text-ghost)', letterSpacing: '0.1em' }}
        >
          © SPICYDEVS
        </span>
      </div>
