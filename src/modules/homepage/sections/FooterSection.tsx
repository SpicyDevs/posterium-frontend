  ...
  >
    ...
    <div
      style={{
        height: 1,
        background:
          'linear-gradient(90deg, transparent 0%, rgba(196,124,46,0.25) 30%, rgba(196,124,46,0.25) 70%, transparent 100%)',
      }}
    />
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div style={{ padding: 'clamp(48px,6vw,80px) clamp(20px,5vw,64px) 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
          <img
            ...
            style={{
              ...
              flexShrink: 0,
              borderRadius: 7,
              boxShadow: '0 0 24px rgba(196,124,46,0.22), 0 4px 12px rgba(7,7,6,0.5)',
            }}
          />
          <div>
            <div
        ...
        >
          Movie and TV posters with live rating badges, served from one URL. Free, open source, no
          strings attached.
        </p>
      </div>
      ...
      <div
        ...
        style={{
          ...
          height: 1,
          background:
            'linear-gradient(90deg, rgba(196,124,46,0.3), rgba(196,124,46,0.06) 70%, transparent)',
          opacity: 0.5,
        }}
      />
      ...
      <div
        aria-hidden="true"
        style={{
          margin: 'clamp(20px,3vw,32px) clamp(20px,5vw,64px)',
          height: 1,
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          >
            <span
              className="mono-font"
              style={{ fontSize: 8, color: 'rgba(196,124,46,0.3)', letterSpacing: '0.15em' }}
            >
              © 2026 SPICYDEVS
            </span>
            <span
              className="mono-font"
              style={{ fontSize: 8, color: 'rgba(196,124,46,0.2)', letterSpacing: '0.12em' }}
            >
              REL 2.0 · MIT
            </span>
          </div>
