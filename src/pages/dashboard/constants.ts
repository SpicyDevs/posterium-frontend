...
export const FEATURES: Feature[] = [
  ...
  { title: 'Instant API URL',        tag: 'API',      size: 'medium', desc: 'One URL returns the complete poster with live ratings baked in. No authentication, no rate limits, no account. Just paste the URL wherever an image is expected — Discord embed, Notion, HTML img tag, anything.' },
  { title: 'Multiple Sources',       tag: 'Posters',  size: 'medium', desc: 'TMDB, Fanart.tv, Metahub, and IMDb poster sources. Textless variants supported. Auto-selects best available art for any title. Falls back gracefully when a source is unavailable.' },
  { title: 'Live Ratings',           tag: 'Data',     size: 'small',  desc: 'IMDb, RT, Metacritic, TMDB, Letterboxd, MAL, AniList — always fetched fresh. Scores in the image reflect what the site shows right now, not what was cached six months ago.' },
  { title: 'Movies, TV & Anime',     tag: 'Content',  size: 'small',  desc: 'Full media type support including TMDB movie/TV IDs, MAL anime IDs, and AniList IDs. Badge types auto-match media type — no manual switching needed.' },
  { title: 'Any Export Format',      tag: 'Output',   size: 'small',  desc: 'SVG for lossless vector clarity at any resolution. PNG, JPG, and WebP for universal compatibility in platforms that block SVG sources.' },
  { title: 'Textless Posters',       tag: 'Design',   size: 'small',  desc: 'Strip title text from artwork using the textless=1 parameter for a clean, cinematic look — popular for Plex home screens and custom gallery setups.' },
  { title: 'Plex & Jellyfin Ready',  tag: 'Servers',  size: 'medium', desc: 'Paste the API URL directly into Plex or Jellyfin as custom poster art. Live ratings update every time the poster is fetched — no manual refreshing required.' },
];
...
export const USE_CASES: UseCase[] = [
  {
    ...
    codeSnippet: 'Poster URL: https://api.spicydevs.xyz/movie/155.svg?r=imdb,rt',
  },
  {
    icon: '🤖', rotateHint: 0.6,
    title: 'Discord Bots',
    ...
    codeSnippet: ".setImage('https://api.spicydevs.xyz/movie/27205.png?r=imdb,rt,meta')",
  },
  {
    icon: '📋', rotateHint: -0.4,
  ...
  },
  {
    ...
    codeSnippet: '<img src="https://api.spicydevs.xyz/movie/872585.png?r=imdb,rt,meta">',
  },
  {
    icon: '⚙️', rotateHint: -0.6,
    ...
    codeSnippet: 'URL: {{base}}/movie/{{tmdb_id}}.png?r=imdb,rt&source=tmdb',
  },
  {
    icon: '🎨', rotateHint: 0.9,
    title: 'Print & Design',
