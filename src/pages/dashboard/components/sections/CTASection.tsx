  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{
        height: 52, display: 'flex', overflow: 'hidden',
      ...
      <div style={{
        ...
        {[['PROD','POSTERIUM'],['DIR','SPICYDEVS'],['SCENE','CTA'],['TAKE','1'],['ROLL','01']].map(([k,v]) => (
          <div key={k} style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
            ...
            <span className="syne-font" style={{
              fontSize: 10, fontWeight: 700, color: 'var(--film-silver)', letterSpacing: '0.06em',
            }}>
              {v}
            </span>
          </div>
      ...
      <div style={{
        ...
        <h2 className="poster-font" style={{
          ...
          color: 'var(--film-cream)', lineHeight: 0.86,
