...
export const GLOBAL_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  @keyframes dust-drift {
    ...
    10%  { opacity: 1; }
    90%  { opacity: 0.6; }
    100% { transform: translateX(120px) translateY(-80px) rotate(180deg); opacity: 0; }
  }
  ...
  .feat-card::before {
    ...
    background: linear-gradient(90deg, transparent, rgba(196,124,46,0), transparent);
  ...
  .feat-card:hover::before {
    background: linear-gradient(90deg, transparent, rgba(196,124,46,0.5), transparent);
  }
  ...
  .uc-card:hover .uc-icon { transform: scale(1.2) rotate(-8deg); }
