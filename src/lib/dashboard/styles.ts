...
// GLOBAL_CSS is injected by Dashboard.tsx via dangerouslySetInnerHTML.
// CRT_CSS is kept here but is NO LONGER USED — the CRT animation was
// permanently removed in the Astro migration (see GLOBAL_INSTRUCTIONS §4).
...
export const GLOBAL_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  @media (max-width: 900px) { .film-perforation { display: none !important; } }
...
// CRT_CSS kept for reference but no longer injected anywhere in the Astro migration
