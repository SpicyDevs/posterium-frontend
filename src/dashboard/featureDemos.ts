// src/dashboard/featureDemos.ts
// ─────────────────────────────────────────────────────────────────────
// Previously duplicated verbatim in both FeaturesSection.tsx and
// CombinedSection.tsx.  Single source of truth here.
// ─────────────────────────────────────────────────────────────────────
...
/** Live API demo image config per feature title. */
...
/** Decorative symbol per feature title. */
...
// Pre-compute full image URLs once at module level so every component
// that imports this file shares the same stable references — no allocation
// during render and no duplicate fetch URLs.
