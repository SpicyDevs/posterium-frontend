// src/dashboard/components/sections/ComparisonSection.tsx
// "THE SPEC SHEET" — Posterium vs unnamed competitors.
// Film negative / exposure log aesthetic: two columns separated by a thick
// amber centre rule. Rows animate in staggered on scroll entry.
// Each row: feature name | Posterium value (amber ✓) | Others value (grey ✗/±).
...
interface Row {
  feature: string;
  sub?: string;        // one-line clarifier shown under feature name
  ours: string;        // what Posterium offers
  theirs: string;      // what others offer
...
const WIN_ICON = (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
    ...
    <path d="M3.5 6l2 2 3-3" stroke="#C47C2E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const LOSS_ICON = (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
    ...
    <path d="M4 4l4 4M8 4l-4 4" stroke="rgba(122,117,110,0.45)" strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 'clamp(12px,2vw,18px) clamp(16px,3vw,28px)' }}>
        <div className="syne-font" style={{ fontSize: 'clamp(10px,1.3vw,12px)', fontWeight: 700, color: 'var(--film-cream)', marginBottom: row.sub ? 3 : 0 }}>
          {row.feature}
        </div>
        {row.sub && (
          <div className="mono-font" style={{ fontSize: 7, color: 'rgba(122,117,110,0.4)', letterSpacing: '0.08em', lineHeight: 1.4 }}>
            {row.sub}
          </div>
        )}
      </div>
      ...
      >
        ...
        <span className="body-font" style={{ fontSize: 'clamp(10px,1.2vw,11px)', color: 'rgba(196,124,46,0.85)', lineHeight: 1.5 }}>
          {row.ours}
        </span>
      </div>
      ...
      >
        ...
        <span
          ...
          style={{
            ...
            color: row.theirStatus === 'partial' ? 'rgba(180,150,80,0.55)' : 'rgba(122,117,110,0.45)',
            lineHeight: 1.5,
          }}
        >
          {row.theirs}
...
export const ComparisonSection = memo(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            flexWrap: 'wrap', gap: 14, marginTop: 10, marginBottom: 32,
          }}
        >
          ...
          <p className="syne-font" style={{ fontSize: 11, color: 'var(--film-silver)', maxWidth: 380, lineHeight: 1.7, textAlign: 'right', paddingBottom: 6 }}>
      ...
      {/* Top sprocket */}
      <div style={{ background: 'rgba(255,255,255,0.01)', borderTop: '1px solid rgba(196,124,46,0.06)' }}>
      ...
      >
        ...
        <div style={{ padding: '10px clamp(16px,3vw,28px)' }}>
          <span className="mono-font" style={{ fontSize: 7, color: 'rgba(122,117,110,0.35)', letterSpacing: '0.18em', textTransform: 'uppercase' }}>
            Feature
          </span>
        </div>
        ...
        >
          ...
          />
          <span className="mono-font" style={{ fontSize: 7, color: 'var(--film-amber)', letterSpacing: '0.16em', textTransform: 'uppercase', fontWeight: 700 }}>
            Posterium
          </span>
        </div>
        ...
        <div style={{ padding: '10px clamp(16px,3vw,28px)', display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          />
          <span className="mono-font" style={{ fontSize: 7, color: 'rgba(122,117,110,0.4)', letterSpacing: '0.16em', textTransform: 'uppercase' }}>
            Others
          </span>
        </div>
      </div>
      ...
      >
        ...
        <span className="mono-font" style={{ fontSize: 7, color: 'rgba(122,117,110,0.25)', letterSpacing: '0.1em' }}>
