...
const LivePreview = memo<{ uc: (typeof USE_CASES)[0] }>(({ uc }) => {
  ...
  const src =
    `${API}/${uc.previewType}/${uc.previewId}.svg` +
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            pointerEvents: 'none',
            background:
              'radial-gradient(ellipse 60% 50% at 50% 50%, rgba(196,124,46,0.04) 0%, transparent 70%)',
          }}
        />
      </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div style={{ fontSize: 28, marginBottom: 16, lineHeight: 1 }}>{uc.icon}</div>
