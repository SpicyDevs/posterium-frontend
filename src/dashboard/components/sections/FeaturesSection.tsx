...
const ICON_MAP: Record<string, string> = {
  'Drag-Drop Editor': '⌖', 'Instant API URL': '⚡', 'Multiple Sources': '⊞',
  'Live Ratings': '◉', 'Movies, TV & Anime': '▣', 'Any Export Format': '◫',
  'Textless Posters': '◻', 'Plex & Jellyfin Ready': '▤',
};
...
const DemoImage = memo<{ feature: typeof FEATURES[0] }>(({ feature }) => {
  ...
  return (
    <div style={{
      ...
      <img
        src={src} alt={feature.title} loading="lazy" decoding="async"
      ...
      <div style={{
        ...
        <code className="mono-font" style={{
          fontSize: 7, color: 'rgba(196,124,46,0.65)', letterSpacing: '0.06em',
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          flexWrap: 'wrap', gap: 12, marginTop: 10, marginBottom: 36,
        }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{
              ...
              <span className="poster-font" style={{
                ...
                color: 'rgba(196,124,46,0.12)', letterSpacing: '0.02em',
                userSelect: 'none',
              }}>
              ...
              <div>
                <span className="mono-font" style={{
                  ...
                  borderRadius: 2, padding: '3px 8px', display: 'block', marginBottom: 6,
                }}>
                  {f.tag}
                </span>
                <div className="syne-font" style={{
                  fontSize: 'clamp(16px,2.5vw,22px)', fontWeight: 800,
            ...
            <p className="body-font" style={{
              fontSize: 13, color: 'var(--film-silver)', lineHeight: 1.78,
            ...
            <div style={{
              ...
              <span className="mono-font" style={{
                fontSize: 8, color: 'rgba(196,124,46,0.38)', letterSpacing: '0.12em',
                textTransform: 'uppercase', flexShrink: 0,
              }}>
                API
              </span>
              <code className="mono-font" style={{
                fontSize: 9, color: 'rgba(240,230,204,0.55)', letterSpacing: '0.04em',
      ...
      <div style={{
        ...
        <span className="mono-font" style={{
          fontSize: 8, color: 'rgba(122,117,110,0.28)', letterSpacing: '0.14em', textTransform: 'uppercase',
        }}>
          {FEATURES.length} FEATURES · MIT LICENSE · OPEN SOURCE
        </span>
        <span className="mono-font" style={{
          fontSize: 8, color: 'rgba(122,117,110,0.22)', letterSpacing: '0.1em',
        }}>
          © SPICYDEVS
        </span>
      </div>
