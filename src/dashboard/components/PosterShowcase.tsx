    ...
    >
      ...
      <div style={{
        ...
        <span className="mono-font" style={{
          fontSize: 7, color: 'rgba(196,124,46,0.45)', letterSpacing: '0.12em',
        }}>
          {entry.label}
        </span>
        <span className="mono-font" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div className="syne-font" style={{
              fontSize: isLarge ? 15 : 11, fontWeight: 700,
              color: '#F0E6CC', marginBottom: 6,
            }}>
              {entry.title}
            </div>
            <div className="body-font" style={{
              fontSize: 10, color: 'rgba(240,230,204,0.5)', lineHeight: 1.4,
              marginBottom: 10,
            }}>
              {entry.note}
            </div>
            <code className="mono-font" style={{
              fontSize: 8, color: 'rgba(196,124,46,0.65)', letterSpacing: '0.06em',
              background: 'rgba(7,7,6,0.7)', padding: '3px 8px', borderRadius: 2,
            }}>
              ?r={entry.badges}
            </code>
          </div>
        ...
        {['tl','tr','bl','br'].map(c => (
          <div key={c} aria-hidden="true" style={{
            ...
            width: isLarge ? 12 : 8, height: isLarge ? 12 : 8,
      ...
      <div style={{
        ...
        <code className="mono-font" style={{
          fontSize: 7, color: 'rgba(196,124,46,0.4)', letterSpacing: '0.06em',
...
const PosterShowcase = memo(() => (
  ...
  >
    ...
    <div aria-hidden="true" style={{
      margin: '24px clamp(20px,5vw,64px) 0', height: 1,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <span className="mono-font" style={{
          ...
          marginRight: 10, textTransform: 'uppercase', flexShrink: 0,
        }}>
          GET
        </span>
        {URL_PARTS.map((p, i) => (
          <code key={i} className="mono-font" style={{ fontSize: 10, color: p.color, letterSpacing: '0.02em' }}>
            {p.text}
          </code>
        ))}
      </div>
      <div style={{
        ...
        {URL_PARTS.map((p, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            <span className="mono-font" style={{
              fontSize: 7, color: 'rgba(122,117,110,0.45)', letterSpacing: '0.12em',
            }}>
              {p.label}
            </span>
          </div>
    ...
    <div style={{
      ...
      <span className="mono-font" style={{
        fontSize: 8, color: 'rgba(122,117,110,0.38)', letterSpacing: '0.12em',
      }}>
      ...
      <span className="mono-font" style={{
        fontSize: 8, color: 'rgba(196,124,46,0.38)', letterSpacing: '0.1em',
      }}>
        api.spicydevs.xyz
      </span>
    </div>
