...
export const QuickBuilder = memo<QuickBuilderProps>(
  ({ defaultTmdbId = '155', defaultMediaType = 'movie', defaultBadges = ['imdb', 'rt'] }) => {
    ...
    const badgeStr = BADGE_OPTIONS.filter((b) => selectedBadges.has(b.id))
      .map((b) => b.id)
      .join(',');
    const url = badgeStr
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: 'rgba(240,230,204,0.4)' }}>
              /{mediaType}/{resolvedId}.svg
            </span>
