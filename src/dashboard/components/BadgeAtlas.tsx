...
const CONTACT_PRINTS: ContactEntry[] = [
  ...
  },
  {
    ...
    year: '1972',
    r: 'imdb,meta',
    positions: 'imdb_x=14&imdb_y=14&meta_x=14&meta_y=88',
    frame: '05',
  },
];
...
const STRIP_PRINTS: ContactEntry[] = [
  {
    ...
    year: '2019',
    r: 'rt,meta',
    positions: 'rt_x=310&rt_y=22&meta_x=310&meta_y=96',
    frame: '06',
  },
  {
    id: '680',
  ...
  },
  {
    ...
    year: '2014',
    r: 'imdb,rt,meta',
    positions: 'imdb_x=14&imdb_y=14&rt_x=14&rt_y=88&meta_x=14&meta_y=162',
    frame: '09',
  },
  {
    id: '278',
...
const FeaturedPoster = memo<{
  ...
  const copy = () => {
    navigator.clipboard
      .writeText(`${API}${shortUrl.replace('…', `blur=8&alpha=0.45&rad=12&${combo.positions}`)}`)
      .then(() => {
        setCopied(true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Select a badge combination below — the featured poster updates live. Every image is a real{' '}
        ...
        {COMBOS.map((c, i) => (
          <button
            ...
            style={{
              ...
              borderRadius: 3,
              color: activeCombo === i ? 'var(--film-amber)' : 'rgba(122,117,110,0.55)',
              cursor: 'pointer',
              padding: '5px 12px',
              fontSize: 8,
              letterSpacing: '0.12em',
