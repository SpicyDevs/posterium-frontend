        ...
        <Tab.Group selectedIndex={tabIndex} onChange={handleIndexChange}>
            <Tab.List className="flex items-center border-b border-white/5 bg-[#0c0c0e] px-2 pt-2">
                <Tab
                    className={({ selected }) => clsx(
                        ...
                        selected ? 'bg-[#18181b] text-indigo-400 after:absolute after:bottom-[-1px] after:left-0 after:right-0 after:h-1 after:bg-[#18181b]' : 'text-zinc-500 hover:text-zinc-300 hover:bg-white/5'
                    )}
                >
            ...
            <Tab.Panels className="flex-1 overflow-hidden relative bg-[#18181b]">
                <Tab.Panel className="h-full focus:outline-none">
                    <PropertyPanel config={config} setConfig={setConfig} selectedIds={selectedIds} viewMode="global" />
                </Tab.Panel>
                <Tab.Panel className="h-full focus:outline-none">
                    <PropertyPanel config={config} setConfig={setConfig} selectedIds={selectedIds} viewMode="selection" />
                </Tab.Panel>
            </Tab.Panels>
        </Tab.Group>
    </div>
