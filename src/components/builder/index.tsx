      ...
      <div className="flex flex-col h-[100dvh] overflow-hidden font-sans bg-[#09090b] text-zinc-200 selection:bg-[#C47C2E]/30">
        ...
        <div className="flex flex-1 overflow-hidden">
          <aside
            ...
            className="hidden lg:flex flex-col bg-[#0d0d0f] border-r border-white/6 z-20 relative shrink-0"
            style={{ width: leftW }}
          >
            <LayerPanel config={config} setConfig={setConfig} selectedIds={selectedIds} onSelect={handleSelection} />
            <div onMouseDown={startResizeLeft} className="absolute inset-y-0 right-0 w-[3px] cursor-col-resize group z-50" title="Resize panel">
              <div className="absolute inset-y-0 right-0 w-[1px] bg-transparent group-hover:bg-[#C47C2E]/50 transition-colors" />
            </div>
          </aside>

          <main id="main-canvas" role="main" aria-label="Poster canvas" className="flex-1 relative bg-[#111113] overflow-hidden"
          ...
          <aside
            ...
            className="hidden lg:flex flex-col bg-[#0d0d0f] border-l border-white/6 z-20 relative shrink-0"
            style={{ width: rightW }}
          >
            <div onMouseDown={startResizeRight} className="absolute inset-y-0 left-0 w-[3px] cursor-col-resize group z-50" title="Resize panel">
        ...
        >
          ...
          >
            <div className="w-9 h-0.75 bg-zinc-700 rounded-full" />
          </div>
