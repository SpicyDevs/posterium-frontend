...
export const tutorialSteps: TutorialStep[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        preview: 'minimal-type',
        previewLabel: 'type first',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        preview: 'corner-stack',
        previewLabel: 'library',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        preview: 'premium-glass',
        previewLabel: 'frosted',
        apply: (config) => ({
          ...config,
          theme: 'glass',
