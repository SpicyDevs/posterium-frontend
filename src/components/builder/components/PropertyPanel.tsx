          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <button
                ...
                className={`h-8 rounded-lg text-[11px] font-medium flex items-center justify-center gap-1.5 transition-all active:scale-95 syne-font${key === 'snapToGrid' ? ' col-span-2' : ''}`}
                style={{
