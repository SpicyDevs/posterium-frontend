...
const PRESETS = [
  ...
  '#ffffff', '#a1a1aa', '#6366f1', '#818cf8',
  '#f43f5e', '#fb923c', '#facc15', '#34d399',
  '#38bdf8', '#c084fc', '#f472b6', '#84cc16',
];

const ColorPicker: React.FC<Props> = memo(({
  value = '#000000', onChange,
  label,
  showOpacity = false, opacity = 1, onOpacityChange,
  className,
}) => {
    ...
    <div className={clsx('space-y-2', className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={openNative}
          className="w-8 h-8 rounded-lg border border-white/15 flex-shrink-0 relative overflow-hidden hover:scale-105 transition-transform active:scale-95 shadow-sm"
