...
const HERO_POSTERS = [
  { id: '872585', type: 'movie', r: 'rt,meta', vars: 'rt_x=10&rt_y=12&meta_x=10&meta_y=86', blur: 8, alpha: 0.46, rad: 10 },
  { id: '155', type: 'movie', r: 'imdb,rt', vars: 'imdb_x=10&imdb_y=12&rt_x=10&rt_y=86', blur: 8, alpha: 0.46, rad: 10 },
  { id: '238', type: 'movie', r: 'imdb', vars: 'imdb_x=10&imdb_y=12', blur: 7, alpha: 0.44, rad: 10 },
  { id: '680', type: 'movie', r: 'imdb,rt,meta', vars: 'imdb_x=10&imdb_y=12&rt_x=10&rt_y=86&meta_x=10&meta_y=160', blur: 8, alpha: 0.46, rad: 10 },
  { id: '27205', type: 'movie', r: 'imdb,rt', vars: 'imdb_x=10&imdb_y=12&rt_x=10&rt_y=86', blur: 8, alpha: 0.46, rad: 10 },
  { id: '278', type: 'movie', r: 'imdb', vars: 'imdb_x=10&imdb_y=12', blur: 7, alpha: 0.44, rad: 10 },
];
    ...
    await Promise.all(
      batch.map(async (job) => {
        ...
        process.stdout.write(
          `\r  [${Math.round((done / total) * 100).toString().padStart(3)}%] ${done}/${total}`,
        );
      }),
    );
  }
